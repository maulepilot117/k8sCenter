...
const TEXTAREA_CLASS =
  "mt-1 w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 font-mono focus:border-brand focus:outline-none focus:ring-1 focus:ring-brand dark:border-slate-600 dark:bg-slate-700 dark:text-white";
                  ...
                  {f.opaqueEntries.map((entry, i) => (
                    <div key={i} class="flex items-start gap-2">
                      ...
                      <button
                        ...
                        onClick={() =>
                          removeOpaqueEntry(i)}
                        class="mt-1 p-2 text-slate-400 hover:text-red-500"
                        title="Remove entry"
                      >
                        <svg
                          class="w-4 h-4"
