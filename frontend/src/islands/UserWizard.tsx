...
const STEPS: WizardStep[] = [
  { label: "Account", sub: "Username & password" },
...
export default function UserWizard({ onClose }: { onClose?: () => void }) {
  ...
  const effectiveK8sGroups =
    f.showAdvanced && f.k8sGroups ? f.k8sGroups : "system:authenticated";
  ...
  return (
    <WizardShell
      ...
      onBack={goBack}
      onNext={
        created.value ? close : currentStep.value === 0 ? goNext : handleSubmit
      }
      nextLabel={
        created.value
          ? "Done"
        ...
        <div class="mx-auto max-w-lg">
          <div class="rounded-lg border border-success bg-success-dim p-6">
            <div class="flex items-center gap-3">
              ...
              <h2 class="text-lg font-semibold text-success">User Created</h2>
            </div>
            <p class="mt-2 text-sm text-success">
              User "{f.username}" has been created successfully. To grant
              permissions, create a Role Binding.
            </p>
              ...
              <div class="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    updateField("roles", checked ? ["admin"] : []);
                  }}
              ...
              <div class="rounded-lg border border-border-primary bg-surface p-4">
                ...
                <dl class="mt-3 space-y-2 text-sm">
                  <div class="flex justify-between">
                    ...
                    <dd class="font-medium text-text-primary">{f.username}</dd>
                  </div>
                  <div class="flex justify-between">
                    <dt class="text-text-muted">K8s Username</dt>
