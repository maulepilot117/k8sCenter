...
import CronJobWizard from "@/src/islands/CronJobWizard.tsx";
import DaemonSetWizard from "@/src/islands/DaemonSetWizard.tsx";
import DeploymentWizard from "@/src/islands/DeploymentWizard.tsx";
import JobWizard from "@/src/islands/JobWizard.tsx";
...
function resolveKind(currentPath: string): {
  ...
  for (const tab of tabs) {
    if (
      ...
      (currentPath.startsWith(tab.href) && currentPath[tab.href.length] === "/")
    ) {
      return {
        kind: tab.kind!,
        title: tab.label,
